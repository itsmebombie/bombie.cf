  ...
  return (
    <div class="App">
      <header class="App-header">
        <img class="blck" width="500" height="500" src="blck.webp" alt="stop posting about blck im tired of seeing it my friends on tiktok " />
        ...
        <p class="text">stop asking where/how to download blck pweaaaasee owo uwu 😭 </p> 
        <a
          class="link"
